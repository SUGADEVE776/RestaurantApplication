...
urlpatterns = [
    ...
    path('feed/<int:pk>', views.Feedback_RestaurantAPI.as_view()),
    path('dishfeed/', views.Feedback_DishAPI.as_view()),
    path('dishfeed/<int:pk>', views.Feedback_DishAPI.as_view()),
    ...
    path('forgotpasswordmobile/', views.Forgot_PasswordMobileAPI.as_view()),
